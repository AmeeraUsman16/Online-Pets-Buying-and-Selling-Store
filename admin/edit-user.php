...
if (isset($_POST['delete-btn'])) {
    ...
    if($run){
        echo "<div class='alert alert-danger mb-0 mt-3'>Account has been Delete</div>";
    }else{
        echo "<div class='alert alert-danger mb-0 mt-3'>Something went wrong</div>";
    }
}
    ...
    <div class="container mt-5">
        ...
        <div class="container mt-5">
            <form action="" method="post">
                ...
                <div class="mb-0">
                    <button type="submit" name="update-btn" class="btn btn-dark p-3 px-5">Update</button>
                    <button type="submit" name="delete-btn" class="btn btn-danger p-3 px-5">Delete</button>
                </div>
            </form>      
        </div>
        <?php } ?>
