    ...
    <div class="container mt-5" >
        <form action="" method="post">
            <div class="form-floating mb-3">
                <input type="text" name="name" class="form-control" id="floatingInputUsername" placeholder="Your Name" style="border: none; border-bottom: 1px solid #000; border-radius:0;width:700px;"
                    required>
            ...
            <div class="form-floating mb-3">
                <input type="number" name="number" class="form-control" id="floatingnumber" placeholder="Number" style="border: none; border-bottom: 1px solid #000; border-radius:0;width:700px;"
                    required>
