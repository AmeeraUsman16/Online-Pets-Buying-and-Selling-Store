<nav class="navbar navbar-expand-lg bg-body-tertiary" style="margin-top:-10px">
    <div class="container-fluid d-flex flex-nowrap" style="background-color: #0597a0;">
        <a class="navbar-brand text-wrap" href="#"
            style="background-color: #0597a0; color: white; font-weight: bold; padding:20px; border-radius: 5px;">
            Pet's Heaven
        </a>
        <button class="navbar-toggler ml-1" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item mx-3">
                    <a class="nav-link btn btn-outline-light rounded-pill px-4 py-2" aria-current="page"
                        href="logout.php" style="color: white;">Logout</a>
                </li>
